...
public class BankTester2 {
	public void start() throws InterruptedException{
		...
		*/
		...
		TimeUnit.SECONDS.sleep(1);
		/*
		System.out.println("Event 13.1 - OnGoingSuspiciousWithdrawal3 (2000)");
		epService.getEPRuntime().sendEvent(onGoingWithdrawal3);
		System.out.println();
		TimeUnit.SECONDS.sleep(1);
		*/
		...
		TimeUnit.SECONDS.sleep(1);
		/*
		System.out.println("Event 15.1 - OnGoingSuspiciousWithdrawal3 (ATM = null)");
		onGoingWithdrawal3.setDoWithdrawal(null);
		epService.getEPRuntime().sendEvent(onGoingWithdrawal3);
		System.out.println();
		TimeUnit.SECONDS.sleep(1);
		*/
