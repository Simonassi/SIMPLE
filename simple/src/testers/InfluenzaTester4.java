...
public class InfluenzaTester4 {
	public void start() throws InterruptedException{
		...
		*/
		...
		System.out.println("Event 13 - Rafael / temp 38 / RH false / Cough");
		patient = new Patient("Rafael", rafaelsCity, 38, false, justCough);
		epService.getEPRuntime().sendEvent(patient);
		System.out.println();
		...
		System.out.println("Event 15 - Rafael / temp 38 / RH true / Cough");
		patient = new Patient("Rafael", rafaelsCity, 38, true, justCough);
		epService.getEPRuntime().sendEvent(patient);
		System.out.println();
		...
		System.out.println("Event 17 - Rafael / temp 39 / RH true / Both");
		...
		System.out.println();
		*/
		System.out.println("Event 21 - Rafael / temp 36 / RH true / Cough");
		patient = new Patient("Rafael", rafaelsCity, 36, true, justCough);
		epService.getEPRuntime().sendEvent(patient);
		System.out.println();
		...
		System.out.println("Event 23 - Rafael / temp 36 / RH true / Both");
		patient = new Patient("Rafael", rafaelsCity, 36, true, coughAndInfection);
		epService.getEPRuntime().sendEvent(patient);
		System.out.println();
