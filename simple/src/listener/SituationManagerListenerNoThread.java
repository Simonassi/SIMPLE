...
public class SituationManagerListenerNoThread<GenericType extends Situation> implements StatementAwareUpdateListener {
    
	public Class<GenericType> typeArgumentClass;
	public static int id = 0;
	
	public SituationManagerListenerNoThread(Class<GenericType> typeArgumentClass){
		...
		for(EventBean event : newEvents){
	    	...
	    	if(	(isActiveStmt && (sit == null || !sit.isActived()))  ){
	    		...
	    		try {
					...
					sit_event.setId(id);
					sit_event.setKey("@"+id+"S");
					id++;
					
					sit_event.doActionAtCreateActivationEvent(newEvents);
				} catch (Exception e) {
	    		...
	    		if( !isActiveStmt && sit != null && sit.isActived()){
	    			...
	    			// Create a situation deactivation object
